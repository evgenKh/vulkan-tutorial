...
void VulkanDriver::initVulkan(uint32_t width, uint32_t height, GLFWwindow* glfwWindow)
    ...
    void VulkanDriver::createTextureImage()
    {
        ...
        VkBuffer stagingBuffer;
        VkDeviceMemory stagingBufferMemory;
        createBufferInternal(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, 
            VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
    ...
    void VulkanDriver::createImageInternal(uint32_t width, uint32_t height,
    ...
    void VulkanDriver::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
        VkCommandBuffer commandBuffer = beginSingleTimeCommands();
